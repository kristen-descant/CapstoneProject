    ...
    return (
        ...
        <div className="bg-white w-3/4 h-3/4 p-5 mt-5 rounded md:h-3/4  flex flex-col justify-center overflow-hidden">
            <div className="w-full h-full flex flex-col items-start justify-center">
                <div className="lg:mb-2 ml-20 pl-10 md:mb-1 sm:mb-0 mb-1 flex-nowrap w-3/4">Not Staff? <Link className="rounded bg-sky-700 hover:bg-sky-900 text-white pl-1 pr-1" to="/signupstudent">Create Student Account</Link></div> 
                <div className="lg:mb-2 ml-20 pl-10 md:mb-1 mb-1 flex-nowrap w-3/4">Already have an account? <Link className="rounded bg-sky-700 hover:bg-sky-900 text-white pl-1 pr-1" to="/loginstaff">Log In</Link></div>
                ...
                <form  onSubmit={signUp} className="w-3/4 ml-20 pl-10">
                    ...
                    <div className="flex flex-row justify-start overflow-hidden mb-1">
                        ...
                        <input className="bg-blue-100 w-[40%] ml-[5.2rem]" type="text" onChange={(e) => setTitle(e.target.value)}/>
                    </div>
                    <div className="flex flex-row justify-start overflow-hidden mb-1">
