...
from .views import (Sign_Up_Staff, Sign_Up_Student, Log_In_Staff, Log_In_Student, Log_Out, Get_User,
                     ...
                     Admin_Room_Assignment, All_Users, All_Room_Assignments)
...
urlpatterns = [
    ...
    path('legalguardian/', Legal_Guardian.as_view(), name='legalguardian'),
    ...
    path('allroomassignments/', All_Room_Assignments.as_view(), name='allroomassignments')
]